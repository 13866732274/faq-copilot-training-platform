"""drop idx_practice_hospital in phase-2

Revision ID: 20260309_04
Revises: 20260309_03
Create Date: 2026-03-09 01:10:00
"""
...
def upgrade() -> None:
    if _index_exists("practices", "idx_practice_hospital"):
        op.drop_index("idx_practice_hospital", table_name="practices")


def downgrade() -> None:
    if not _index_exists("practices", "idx_practice_hospital"):
